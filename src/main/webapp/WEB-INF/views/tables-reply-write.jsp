                ...
                <div class="col-12">
                    ...
                    <div class="shortcodes_content">
                        <div class="table-responsive">
                        	<form id="qna_reply_write_form" method="post">
	                            <table class="table mb-0 table-bordered">
	                                <thead>
	                                    <tr>
	                                        <th scope="col" class="board_title">
	                                        	<input type="text" name="q_title" value="[RE] ${qna.q_title}" id="q_title_txt" placeholder=" title" />
	                                        </th>
                    	...
                    	<div id="qna_btn_container">
							<input class="qna_btn reply_write" type="button" value="등록" />
